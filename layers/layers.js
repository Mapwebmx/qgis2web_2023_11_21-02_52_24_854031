...
var format_PERLIIS_3 = new ol.format.GeoJSON();
var features_PERLIIS_3 = format_PERLIIS_3.readFeatures(json_PERLIIS_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PERLIIS_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PERLIIS_3.addFeatures(features_PERLIIS_3);
var lyr_PERLIIS_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_PERLIIS_3, 
                style: style_PERLIIS_3,
                interactive: true,
                title: '<img src="styles/legend/PERLIIS_3.png" /> PERLIIS'
            });
...
lyr_SKPK_SEMENANJUNG_LAT_LONG1_0.setVisible(true);lyr_SMPK_SEMENANJUNG_LAT_LONG_1.setVisible(true);lyr_OSMStandard_2.setVisible(true);lyr_PERLIIS_3.setVisible(true);lyr_PERLIS_4.setVisible(true);lyr_KEDAH_5.setVisible(true);lyr_PERAK_6.setVisible(true);lyr_PAHANG_7.setVisible(true);lyr_SELANGOR_8.setVisible(true);lyr_JOHOR_9.setVisible(true);lyr_MELAKA_10.setVisible(true);lyr_KELANTAN_11.setVisible(true);lyr_TERENGGANU_12.setVisible(true);lyr_NEGERISEMBILAN_13.setVisible(true);lyr_PULAUPINANG_14.setVisible(true);lyr_JLNUTAMA_15.setVisible(true);
var layersList = [group_group1,lyr_OSMStandard_2,lyr_PERLIIS_3,lyr_PERLIS_4,lyr_KEDAH_5,lyr_PERAK_6,lyr_PAHANG_7,lyr_SELANGOR_8,lyr_JOHOR_9,lyr_MELAKA_10,lyr_KELANTAN_11,lyr_TERENGGANU_12,lyr_NEGERISEMBILAN_13,lyr_PULAUPINANG_14,lyr_JLNUTAMA_15];
...
lyr_PERLIIS_3.set('fieldAliases', {'id': 'id', });
...
lyr_PERLIIS_3.set('fieldImages', {'id': 'TextEdit', });
...
lyr_PERLIIS_3.set('fieldLabels', {'id': 'inline label', });
